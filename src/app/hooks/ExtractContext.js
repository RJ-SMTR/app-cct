...
export function ExtractProvider({ children }) {
    ...
    function getStatements(previousDays){
        const requestData = previousDays > 0 ? { previousDays: previousDays } : {}
    ...
    const chartOptions = {
      ...
      return(  <ExtractContext.Provider
            value={{ chartOptions, getStatements, average, previousDays, setPreviousDays, statements}}
        >
            {children}
