                            ...
                            <TableBody>
                                {!isLoading ? (
                                    reportList ? (
                                                    ...
                                                    Object.entries(
                                                       reportList.reduce((acc, item) => {
                                                         
                                                              const  key = `${item.datapagamento}-${item.status}`;
                                                            if (!acc[key]) acc[key] = [];
                                                            acc[key].push(item);
                                                            return acc;
                                                        }, {})
                                                                ...
                                                                <TableRow>
                                                                    <Box className="flex pb-[20px] gap-10">
                                                                        ...
                                                                        <p className="font-bold">
                                                                            {formatter.format(items[0].subtotalByDate)}
                                                                        </p>
                                                                    </Box>
                                                                </TableRow>
                                                            </React.Fragment>
                                ...
                                <TableRow key={Math.random()}>
                                    ...
                                    <TableCell className='font-bold'> {formatter.format(reportList[0].total)}</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </div>
